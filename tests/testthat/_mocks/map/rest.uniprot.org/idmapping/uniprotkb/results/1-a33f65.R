structure(list(method = "GET", url = "https://rest.uniprot.org/idmapping/uniprotkb/results/1?format=tsv&fields=accession%2Cid%2Cgene_primary&size=1", 
    status_code = 200L, headers = structure(list(Server = "nginx/1.17.7", 
        ...
        Link = "<https://rest.uniprot.org/idmapping/uniprotkb/results/1?format=tsv&fields=accession,id,gene_primary&cursor=j5xqrofo4&size=1>; rel=\"next\"", 
