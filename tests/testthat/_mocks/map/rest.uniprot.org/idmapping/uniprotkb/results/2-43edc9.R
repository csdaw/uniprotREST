structure(list(method = "GET", url = "https://rest.uniprot.org/idmapping/uniprotkb/results/2?format=tsv&fields=accession%2Cid%2Cgene_primary&size=500", 
    status_code = 200L, headers = structure(list(Server = "nginx/1.17.7", 
        ...
        Date = "Sat, 07 Jan 2023 07:26:27 GMT", `X-UniProt-Release` = "2022_05", 
