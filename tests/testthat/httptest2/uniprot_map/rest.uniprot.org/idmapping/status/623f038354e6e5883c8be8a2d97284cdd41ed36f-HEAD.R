structure(list(method = "HEAD", url = "https://rest.uniprot.org/idmapping/uniprotkb/results/623f038354e6e5883c8be8a2d97284cdd41ed36f", 
    status_code = 200L, headers = structure(list(Server = "nginx/1.17.7", 
        ...
        Date = "Sat, 07 Jan 2023 05:55:28 GMT", `X-UniProt-Release` = "2022_05", 
