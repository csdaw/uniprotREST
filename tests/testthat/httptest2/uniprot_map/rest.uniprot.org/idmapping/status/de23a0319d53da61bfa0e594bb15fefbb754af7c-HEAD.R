structure(list(method = "HEAD", url = "https://rest.uniprot.org/idmapping/results/de23a0319d53da61bfa0e594bb15fefbb754af7c", 
    status_code = 200L, headers = structure(list(Server = "nginx/1.17.7", 
        ...
        Date = "Sat, 07 Jan 2023 05:55:38 GMT", `X-UniProt-Release` = "2022_05", 
