structure(list(method = "GET", url = "https://rest.uniprot.org/idmapping/uniprotkb/results/623f038354e6e5883c8be8a2d97284cdd41ed36f?format=tsv&fields=accession,id,gene_primary&cursor=j5xqrofo4&size=1", 
    status_code = 200L, headers = structure(list(Server = "nginx/1.17.7", 
        ...
        Date = "Sat, 07 Jan 2023 05:55:25 GMT", `X-UniProt-Release` = "2022_05", 
