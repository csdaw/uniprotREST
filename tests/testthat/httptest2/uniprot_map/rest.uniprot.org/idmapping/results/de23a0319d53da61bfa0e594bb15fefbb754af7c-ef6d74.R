structure(list(method = "GET", url = "https://rest.uniprot.org/idmapping/results/de23a0319d53da61bfa0e594bb15fefbb754af7c?format=tsv&size=500", 
    status_code = 200L, headers = structure(list(Server = "nginx/1.17.7", 
        ...
        Date = "Sat, 07 Jan 2023 05:55:39 GMT", `X-UniProt-Release` = "2022_05", 
    ...
    body = charToRaw("From\tTo\nP99999\tENSG00000172115.9\nP99998\tENSPTRG00000018996\nP99998\tENSPTRG00000043922\n")), class = "httr2_response")
